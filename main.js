...
$(function() {
  ...
  function set_settings() {
    ...
    settings.condition_2_likes = [12000, 15000,35000,80000,150000];  
	...
	settings.condition_1_adjusted_likes = [12000, 35000,80000,110000, 130000]; // 5
    ...
    settings.likes_by = ['Jade','Ryan','Tanvi','Annaaaaa','Gabi']; 
  }
